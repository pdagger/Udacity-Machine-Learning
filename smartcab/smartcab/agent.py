...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.a = 0.01 # a parameter in exploration update
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.t += 1
            #math.exp(-self.a * self.t) #1 / self.t ** 2 #self.a ** self.t
    ...
    def createQ(self, state):
        ...
        # Check if state exists, if not add to Q with empty dictionary
        self.Q[state] = self.Q.get(state, {}) 
        # When empty state assign 0 to all possible actions
        if self.Q[state] == {}:
    ...
    def choose_action(self, state):
        ...
        if self.learning == False:
            ...
            # Action with max Q
                ...
                actions = [act for act, q in self.Q[self.state].items() if q == maxQ]
